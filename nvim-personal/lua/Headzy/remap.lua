...
vim.keymap.set("n", "]d", function() vim.diagnostic.jump({count= 1, float=true}) end)
vim.keymap.set({ "n", "x" }, "<leader>vdc", function() vim.diagnostic.config({virtual_text = false}) end)
vim.keymap.set({ "n", "x" }, "<leader>vdo", function() vim.diagnostic.config({virtual_text = true}) end)
vim.keymap.set({ "n", "x" }, "<leader>vf" , function() vim.lsp.buf.format({async = false, timeout_ms = 10000}) end)
