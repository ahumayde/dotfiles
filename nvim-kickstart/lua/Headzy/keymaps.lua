...
vim.keymap.set("n", "<leader>n", "<C-w>", { desc = "Window Commands (:help windcmd)" })
vim.keymap.set("n", "<leader>w", "<C-w>", { desc = "Window Commands (:help windcmd)" })
